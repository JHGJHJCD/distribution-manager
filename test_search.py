...
check("auto-selected details name", tab.l_name.text(), "יהודה כהן")
check("husband id shown in details", tab.l_id.text(), "123456789")
tab.search_input.setText("444555666"); tab._run_search()
check("wife id → details name", tab.l_name.text(), "יהודה לוי")
